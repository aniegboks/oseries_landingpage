            ...
            {currentWord.split('').map((letter, i) => (
                <motion.span
                    ...
                    <motion.span
                        ...
                        className="bg-gradient-to-r from-secondry to-alternate bg-clip-text text-transparent">
                        {letter}
                    </motion.span>
                    <motion.span
                        initial={{ opacity: 0 }}
                        ...
                        className="absolute bottom-[3px] left-[1px] right-0 top-[3px] bg-gradient-to-r from-secondry to-alternate" />
                </motion.span>
            ))}
        </span>
    );
